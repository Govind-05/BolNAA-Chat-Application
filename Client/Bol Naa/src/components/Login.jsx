        ...
        <>
            <div className="login-container">
                ...
                {loginForm?
                    ...
                    <input className="focus:border-green-400 focus:border-2" type="text" minLength="4" autoCorrect="off" autoComplete="off" placeholder='UserName' name="userName" value={loginData.userName} onChange={changeLoginInfo}/>
                    <input className="focus:border-green-400 focus:border-2" type="password" placeholder='Password' name='password' value={loginData.password} onChange={changeLoginInfo}/>
